...
def run_generation_task(input_root: str, output_root: str, scene: str, motion_mode: str, degree: float, gpu_id: int, method: str = "faithful_svd") -> str:
...
if __name__ == '__main__':
    ...
    if args.dataset == "davis":
        ...
        output_root = args.output_root or "./davis_output_scripted_cam"
        ...
        output_root = args.output_root or "./tanks_and_temples_output_scripted_cam"
    else:
